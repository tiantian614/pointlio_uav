...
extern esekfom::esekf<state_output, 30, input_ikfom> kf_output; // hr: 相比input多了omg和acc（6维）
...
//#define G_m_s2 (9.78)         // Gravaty const in ChengDu/China
...
/* by hr
 * @brief  将原始的点云数据压缩成一个简洁的时间序列，j表示每个连续时间内点的数量
 * @return vector<int> time_seq
 */
template<typename T>
