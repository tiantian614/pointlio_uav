...
extern std::string lid_topic, imu_topic, gps_topic;
...
extern bool   runtime_pos_log, pcd_save_en, path_en, trajectory_save_en;
...
extern bool use_multi_lidar;
extern queue<livox_ros_driver::CustomMsg::ConstPtr> livox1_queue, livox2_queue;
extern vector<double> extrinT_br;
extern vector<double> extrinR_br;
extern Eigen::Matrix4d tf_base2ref;
extern std::string lid_topic_multi;
extern int lidar_type_multi;
