<<<<<<< HEAD
# Point-Lio-MultiLidar
得益于point-lio在剧烈运动下的优秀表现，在point-lio基础上新增多雷达合并，支持多雷达定位（如前后两个avia），以应对在快速飞行过程中单个avia视野不够的情况。

合并过程与里程计本身分离，方便移植到其他LIO中（已测试fast-lio2）
## 测试场景
### 手持测试
已完成，待更新
### 无人机飞行测试
...
>>>>>>> b43bd7bae90e1ca53f3b90b54001769639a76ea5
